...
def getStudyRegions():
    ...
    conn = py.connect('Driver=ODBC Driver 11 for SQL Server;SERVER=' +
                      comp_name + '\HAZUSPLUSSRVR; Trusted_Connection=yes')
...
class HazusDB():
    ...
    def createConnection(self):
        ...
        for driver in drivers:
            try:
                conn = py.connect('Driver={d};SERVER={cn}\HAZUSPLUSSRVR; Trusted_Connection=yes'.format(
    ...
    def createWriteConnection(self, databaseName):
        ...
        """
        engine = create_engine('mssql+pyodbc://@.\\HAZUSPLUSSRVR/' +
                               databaseName+'?driver=SQL+Server&trusted_connection=yes')
